...
constexpr auto* windowName      = _T("fixed by ac and Haxor");
...
void Menu::runLoop()
{
    ...
    while (shouldBreak == false) {
        ...
        if (ImGui::Begin("", nullptr, windowFlags)) {
            ...
            ImGui::Separator();
            if (ImGui::Button("Click this for help")) {
                system("start https://discord.gg/FaFjMcpj"); // if you delete this ur done:)
            }
            ImGui::Separator();
